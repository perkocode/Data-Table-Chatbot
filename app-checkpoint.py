...
app.secret_key = "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"  # should be secret in production
...
def is_doc_question(query):
    keywords = ["mean", "describe", "definition", "what is", "explain", "field", "column", "documentation", "Documentation"]
